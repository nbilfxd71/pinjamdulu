...
<div class="container-fluid">
    <h1 class="mb-4">Tambah Alat Baru</h1>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('admin.alats.store') }}">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control @error('stok') is-invalid @enderror" id="stok" name="stok" value="{{ old('stok') }}" min="1" required>
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-control @error('kondisi') is-invalid @enderror" id="kondisi" name="kondisi" required>
                                ...
                                <option value="perbaikan" @if(old('kondisi') === 'perbaikan') selected @endif>Perbaikan</option>
                            </select>
